...
module.exports = class ApiMerger {
  ...
  mergeMockExtensions(localSwagger, basePath, mediaTypes, additionalHeaders) {
    try {
      ...
      // Remove attribut "example" in object description because it is not supported by AWS ApiGateway
