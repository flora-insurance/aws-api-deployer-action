...
module.exports = async ({
  ...
  try { 
    ...
    if (!awsApi) {
      ...
      const localSwaggerExt = apiMerger.mergeExtensions(localSwagger, basePath, mediaTypes, additionalHeaders);
      ...
      const mergedSwaggerExt = apiMerger.mergeExtensions(mergedSwagger, basePath, mediaTypes, additionalHeaders);
